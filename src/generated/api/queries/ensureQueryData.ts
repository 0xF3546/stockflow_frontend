...
import { getApiBalance, getApiFx, getApiPortfolio, getApiStocksSearch, getHealth } from "../requests/services.gen";
import { GetApiFxData, GetApiStocksSearchData } from "../requests/types.gen";
...
export const ensureUseGetApiFxData = (queryClient: QueryClient, clientOptions: Options<GetApiFxData, true>) => queryClient.ensureQueryData({ queryKey: Common.UseGetApiFxKeyFn(clientOptions), queryFn: () => getApiFx({ ...clientOptions }).then(response => response.data) });
