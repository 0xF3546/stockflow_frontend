...
export const prefetchUseGetApiFx = (queryClient: QueryClient, clientOptions: Options<GetApiFxData, true>) => queryClient.prefetchQuery({ queryKey: Common.UseGetApiFxKeyFn(clientOptions), queryFn: () => getApiFx({ ...clientOptions }).then(response => response.data) });
